    ...
    unmatched.some(function (signature, i) {
      ...
      switch (forkId) {
        case Transaction.FORKID_BCH:
          ...
          break
        case Transaction.FORKID_BTH:
          hash = transaction.hashForBithereumSignature(vin, input.signScript, value, parsed.hashType)
          break
        default:
          if (input.witness) {
...
TransactionBuilder.prototype.enableBithereum = function (enable) {
  if (typeof enable === 'undefined') {
    enable = true
  }

  this.bithereum = enable
}
...
TransactionBuilder.fromTransaction = function (transaction, network, forkId) {
  ...
  if (typeof forkId === 'number') {
    if (forkId === Transaction.FORKID_BTH) {
...
TransactionBuilder.prototype.sign = function (vin, keyPair, redeemScript, hashType, witnessValue, witnessScript) {
  ...
  var signatureHash
  if (this.bithereum) {
    signatureHash = this.tx.hashForBithereumSignature(vin, input.signScript, witnessValue, hashType, input.witness)
